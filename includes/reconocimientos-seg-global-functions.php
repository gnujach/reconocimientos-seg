 ...
 */
function reconocimientos_get_max( $array ) {

	return Reconocimientos_Seg_Globals::get_max( $array );
 ...
 */
function reconocimientos_get_svg( $svg ) {

	return Reconocimientos_Seg_Globals::get_svg( $svg );
 ...
 */
function reconocimientos_get_template( $name ) {

	return Reconocimientos_Seg_Globals::get_template( $name );	

}

class Reconocimientos_Seg_Globals {
	 ...
	 */
 	public static function get_template( $name ) {
		 ...
		 */
		apply_filters( 'reconocimientos-template-paths', $locations );
	 ...
	 /**
	 * Obtener el nombre de un post
	 * @param int $parent_post_id del post
	 * use get_post_title ($id)
	 */
	 public function get_post_title( $parent_post_id ) {
